...
class Git():
    ...
    def log(self, repo_id, firstSync):
        ...
        # Create a map for the true structure
        # check all the commits and create the depending stucture
...
class BDFE():
    ...
    def log(self, repo_id, firstSync):
        ...
        # check all the commits and create the depending structure (structure-track)
        print(f"-----Staring create structure-----")
        for data in info:
            if data=="":
                continue
        ...
        for data in info:
            ...
            if(len(c.parent_hash)==2):
                ...
                #link this commit to its parent, and update the parent commit
